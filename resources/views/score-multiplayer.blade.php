  ...
  <main id="main">
    ...
    <section id="recap" class="section-with-bg2">
      ...
      <div class="container" data-aos="zoom-in-down">
        ...
        ?>
        <div class="row">
          <div class="col-md-6" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="1200">
            <div class="card mb-5 mb-lg-0">
              <div class="card-body">
                <div id="img-container">
                  <img src="{{ asset('img/iPM/img/first-place.png') }}" alt="medal">
                </div>
          ...
          <div class="col-md-6" data-aos="flip-right"
            ...
            <div class="card mb-5 mb-lg-0">
              <div class="card-body">
                <div id="img-container">
                  <img src="{{ asset('img/iPM/img/second-place.png') }}" alt="medal">
                </div>
                <h5 class="card-title text-center">¡¡<?php echo $looser; ?>!!</h5>
                <hr>
                
                <h6 class="card-subtitle text-center">Has quedado en Segundo lugar</h6>
