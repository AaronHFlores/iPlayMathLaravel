...
<div class="row mb-4">
  <div class="col-md-4">
    ...
    <!-- <section> begin ============================-->
    <section id="customers"><!-- end of .container-->
        <h1>Bienvenido a iPlayMath </h1>
        <h2>Para ofrecerte una experiencia adecuada segun tus conocimientos es necesario que contestes el examen diagnostico para asignarte un score base el cual te servira como punto de partida</h2>
        <div class="col-md-6">
